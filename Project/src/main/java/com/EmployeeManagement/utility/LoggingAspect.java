package com.EmployeeManagement.utility;
	...
	@AfterThrowing(pointcut = "execution(* infy.EmployeeManagement.dao.*Impl.*(..))", throwing = "exception")
	...
	@AfterThrowing(pointcut = "execution(* infy.EmployeeManagement.service.*Impl.*(..))", throwing = "exception")
